						...
						<div class="footer__item-wrap">
							...
							<ul class="footer__social-list">
								<li class="footer__social-list-item">
									<a href="{{$frontendSettings->facebook}}" target="blank" class="footer__social-list-item-lisk">
										<i class="fab fa-facebook-f"></i>
									</a>
								</li>
								<li class="footer__social-list-item">
									<a href="{{$frontendSettings->twitter}}" target="blank" class="footer__social-list-item-lisk">
										<i class="fab fa-twitter"></i>
									</a>
								</li>
								<li class="footer__social-list-item">
									<a href="{{$frontendSettings->instagram}}" target="blank" class="footer__social-list-item-lisk">
										<i class="fab fa-instagram"></i>
									</a>
								</li>
								<li class="footer__social-list-item">
									<a href="{{$frontendSettings->youtube}}" target="blank" class="footer__social-list-item-lisk">
