            ...
            <div class="card card-primary">
                ...
                <form action="{{url('/admin/product/update/'.$product->id)}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sku_code" value="{{$product->sku_code}}" name="sku_code" placeholder="Enter SKU Code" readonly>
                    </div>
                    <div class="form-group">
                ...
                <button type="button" class="btn btn-primary" id="add_size">Add More</button>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="galleryImage" name="galleryImage[]" multiple accept="image/*">
                          <label class="custom-file-label" for="image">Choose file</label>
                        </div>
                      </div>
